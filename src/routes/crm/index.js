...
import * as url from "Helpers/url/crmRoutes";
      ...
      <div className="saas-dashboard">
        <Switch>
          ...
          <Route
            exact
            path={url.leadPage}
            component={async.crm_lead_component}
          />
          ...
          <Route
            exact
            path={url.dealPage}
            component={async.crm_deal_component}
          />
